...
export default function AqiInfo() {
  ...
  return (
    <div className="flex flex-col w-69 md:w-70 h-fit absolute z-50 pointer-events-auto rounded-lg bg-background/75 p-3 bottom-10 right-3 border border-white/25 gap-2">
      <div
      ...
      {!minimized && (
        <div className="contents">
          <div className="grid grid-cols-[27%_1fr] gap-x-4 gap-y-1 grid-rows-6 w-full h-full items-center justify-center">
            {AQI_COLORS.map((item) => (
